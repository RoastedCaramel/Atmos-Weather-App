...
import { formatLocalTime, iconURL } from '../services/weather';
            ...
            <div className='flex flex-row items-center justify-center space-x-2 text-white text-sm py-3'>
                ...
                <p className='font-light'>
                    Rise: <span className='font-medium ml-1'>
                        {formatLocalTime(sunrise,timezone,'hh:mm a')}</span></p>
                ...
                <p className='font-light'>
                    ...
                    {formatLocalTime(sunset,timezone,'hh:mm a')}</span></p>
                ...
                <p className='font-light'>
                    Rise: <span className='font-medium ml-1'>{temp_min.toFixed()}°</span></p>
