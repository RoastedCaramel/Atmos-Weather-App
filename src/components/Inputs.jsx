        ...
        <div className='flex flex-row justify-center my-6'>
            <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
                <input
                    ...
                    type="text"
                    placeholder='Search'
                    className="text-xl font-light p-2  w-full shadow-xl capitalize rounded-3xl px-10" />
            ...
            <div className='flex flex-row w-1/4 items-center justify-center'>
                ...
                <button name="imperial" className="text-xl text-white font-light hover:scale-125 transition ease-out" onClick={handleUnitChange}>°F</button>
            </div>
        </div>
    );
}
